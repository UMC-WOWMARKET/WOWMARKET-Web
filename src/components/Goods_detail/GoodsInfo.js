	...
	return (
		<div className="GoodsInfo">
			<div className='line' style={{marginBottom:'12px'}}>
				<div className='category' style={{color:'#646464', fontSize: '20px', fontWeight:'400', marginRight:'10px'}}>{category}</div>
				<div className='univ' style={{color:'#A0A0A0', fontSize: '20px', fontWeight:'400'}}>{univ}</div>
			</div>

			<div className='line' style={{justifyContent:'space-between', marginBottom:'16px'}}>
				<div className='name' style={{color:'#646464', fontSize: '28px', fontWeight:'600'}}>{name}</div>
				<div className='nickname' style={{color:'#A0A0A0', fontSize: '16px', fontWeight:'400'}}>제작 {nickname}</div>
			</div>

			<img src={thumbnail} style={{width:'100%', borderRadius:'10px', marginBottom:'24px'}}/>

			<div className='line'>
				<div style={{color:'#646464', fontSize: '20px', fontWeight:'400', marginBottom:'12px'}}>{description}</div>
			</div>

			<div className='line'>
				<div style={{color:'#A0A0A0', fontSize: '20px', fontWeight:'400', marginBottom:'36px'}}>기간 {startDate} ~ {endDate}</div>
			</div>
